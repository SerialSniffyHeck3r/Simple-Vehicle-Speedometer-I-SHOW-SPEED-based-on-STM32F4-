...
So yeah.. I needed some device that I can easily carry, install, remove on a rental vehicle. My initial thought was to make a device thatn warns speeding whenever I floor and sending her, with my leftover parts from one of my big main project.
However, the part that I use is clearly an overkill for this purpose. Maybe I can integrate a whole lot of features that even a complete aftermarket HUD product doesn't provide? 
...
Included STL file is a 3d print model for casing. Print and slap everything in a case. i
